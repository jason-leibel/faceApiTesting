...
function startVideo() {
    // Heard this was depricated? Still works though.
...
video.addEventListener('play', () => {
    ...
    setInterval(async () => {
        ...
        // 80% positivity on being sad.
        if (faceDetections !== null  && typeof(faceDetections[0]) !== "undefined" && faceDetections[0].expressions.sad > 0.8) {
